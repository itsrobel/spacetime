...
import DeckCard from "@/app/_components/deck-card";
...
const FlashcardTable = ({
  ...
  const [selectedFlash, setSelectedFlash] = useState<FlashCard | null>(null);

  const [isFlashDialogOpen, setIsFlashDialogOpen] = useState(false);

  const handleFlashClick = (flash: FlashCard) => {
    if (isMobile) {
